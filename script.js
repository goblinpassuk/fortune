...
(() => {
  ...
  function init(){
    ...
    const openInstructions=()=>{elements.printArea.classList.add('instructions-preview');document.body.style.overflow='hidden';};
    $('viewInstructionsButton').onclick=openInstructions;$('navInstructionsButton').onclick=openInstructions;$('heroInstructionsButton').onclick=openInstructions;$('closeInstructionsButton').onclick=()=>{elements.printArea.classList.remove('instructions-preview');document.body.style.overflow='';};
